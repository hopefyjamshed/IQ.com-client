    ...
    return (
        <div className='flex items-center justify-between'>
            ...
            <div className='mr-3'>
                ...
                <div className={` bg-blue-900 p-2 duration-500 ease-in md:bg-white md:flex md:inline absolute right-0 rounded-md mr-7 md:top-3 ${(open) ? '-right-7' : '-right-96'} md:right-7`}>
